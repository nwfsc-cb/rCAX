...
For data within the Natural Origin Spawner Abundance (NOSA) HLI tables, there is a column `estimatetype` that was developed when it became clear that some data were not available at the spawner abundance level, but instead at the escapement level. One of the two, "spawner abundance" or "escapement", should be indicated and any details about prespawn mortality should be included in the methods/protocol documentation column. 
