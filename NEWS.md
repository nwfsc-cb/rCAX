...
* documentation: cleaned up basics.Rmd, only have api ref for the base api functions, edited the Readme. Added cax.Rmd with more details on the CAX database.
